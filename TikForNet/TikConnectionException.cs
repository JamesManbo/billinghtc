...
namespace TikForNet
{
    ...
    /// <see cref="https://github.com/danikf/TikForNet/wiki/SSL-connection"/>
    /// </summary>
    public class TikConnectionSSLErrorException : TikConnectionException
    {
        public TikConnectionSSLErrorException(Exception innerException)
            : base("API-SSL error (see https://github.com/danikf/TikForNet/wiki/SSL-connection)." + innerException.Message, innerException)
        {
        }
    }
}
