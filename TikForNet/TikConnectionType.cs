...
namespace TikForNet
{
    ...
    public enum TikConnectionType
    {
        ...
        Api,
        /// <summary>
        /// Mikrotik API-SSL connection (supports only mode with certificate on mikrotik). See https://github.com/danikf/TikForNet/wiki/SSL-connection for details.
        /// </summary>
        ApiSsl,
        /// <summary>
        ...
        Api_v2,
        /// <summary>
        /// Mikrotik API-SSL connection for then RouterOS version 6.43 and newer. (supports only mode with certificate on mikrotik). See https://github.com/danikf/TikForNet/wiki/SSL-connection for details. 
        /// </summary>
        [Obsolete("Use 'Api' version - works for both old and new version of the login")]
        ApiSsl_v2,
        /// <summary>
