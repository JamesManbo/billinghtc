...
{
    public class ContractIntegrationEventService : IContractIntegrationEventService
    {
        private readonly Func<DbConnection, IIntegrationEventLogService> _integrationEventLogServiceFactory;
        private readonly IEventBus _eventBus;
        private readonly ContractDbContext _contractContext;
        private readonly IIntegrationEventLogService _eventLogService;
        private readonly ILogger<ContractIntegrationEventService> _logger;

        public ContractIntegrationEventService(
            Func<DbConnection, IIntegrationEventLogService> integrationEventLogServiceFactory,
            IEventBus eventBus,
            ContractDbContext contractContext,
            ILogger<ContractIntegrationEventService> logger)
        {
