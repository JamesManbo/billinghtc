...
BEGIN
    ...
    SELECT DISTINCT sp.Id, sp.PermissionCode, sp.PermissionName, sp.PermissionPage, sr.RoleName, sr.RoleCode
	FROM Users su
	...
	SELECT ep.Id, ep.PermissionCode, ep.PermissionName, ep.PermissionPage, ep.RoleName, ep.RoleCode
