	...
	#Routine body goes here...
 		...
 		CREATE TEMPORARY TABLE reportTb
			...
			t1.CreatedDate,
				...
				t10.GroupName AS ServiceGroupName,
			...
			INNER JOIN ITC_FBM_Contracts.ContractorProperties AS t3 ON t3.ApplicationUserIdentityGuid = t2.ApplicationUserIdentityGuid
