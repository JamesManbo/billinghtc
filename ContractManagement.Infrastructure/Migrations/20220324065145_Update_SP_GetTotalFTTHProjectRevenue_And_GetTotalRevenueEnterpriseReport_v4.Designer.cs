...
namespace ContractManagement.Infrastructure.Migrations
{
    ...
    [Migration("20220324065145_Update_SP_GetTotalFTTHProjectRevenue_And_GetTotalRevenueEnterpriseReport_v4")]
    partial class Update_SP_GetTotalFTTHProjectRevenue_And_GetTotalRevenueEnterpriseReport_v4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.InContractAggregate.ContractSharingRevenueLine", b =>
                {
                    ...
                    b.Property<bool>("HasStartPointSharing")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<string>("OutServiceChannelUid")
                        .HasColumnType("varchar(68) CHARACTER SET utf8mb4")
                        .HasMaxLength(68);
                    ...
                    b.Property<decimal>("SharedTotalAmount")
                        .HasColumnType("decimal(65,30)");

                    b.Property<int?>("SharingDuration")
                        .HasColumnType("int");

                    b.Property<DateTime?>("SharingFrom")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("SharingTo")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.InContractAggregate.SharingRevenueLineDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("SharingAmount")
                        .HasColumnType("decimal(65,30)");

                    b.Property<int?>("SharingLineId")
                        .HasColumnType("int");

                    b.Property<string>("SharingLineUid")
                        .HasColumnType("varchar(68) CHARACTER SET utf8mb4")
                        .HasMaxLength(68);
                    ...
                    b.HasIndex("SharingLineId");

                    b.ToTable("SharingRevenueLineDetails");
                });
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.OutContractAggregate.ContractEquipment", b =>
                {
                    ...
                    b.Property<float>("ActivatedUnit")
                        .HasColumnType("float");
                    ...
                    b.Property<float>("SupporterHoldedUnit")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.OutContractAggregate.OutContractServicePackage", b =>
                {
                    ...
                    b.Property<bool?>("IsSupplierConfirmation")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.OutContractAggregate.OutputChannelPoint", b =>
                {
                    ...
                    b.Property<int>("ConnectionPoint")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.OutContractAggregate.ServicePackageSuspensionTime", b =>
                {
                    ...
                    b.Property<decimal>("DiscountAmountBeforeTax")
                        .HasColumnType("decimal(65,30)");
                    ...
                    b.Property<decimal>("RemainingAmountBeforeTax")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.TransactionAggregate.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("ContractNewExpirationDate")
                        .HasColumnType("datetime(6)");

                    b.Property<int>("ContractRenewMonths")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsMultipleTransaction")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<string>("ReasonCancelAcceptance")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int?>("ReasonType")
                        .HasColumnType("int");

                    b.Property<decimal?>("RenewFee")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.TransactionAggregate.TransactionChannelPoint", b =>
                {
                    ...
                    b.Property<int?>("ContractPointId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.TransactionAggregate.TransactionChannelTax", b =>
                {
                    ...
                    b.Property<int?>("ContractChannelTaxId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.TransactionAggregate.TransactionEquipment", b =>
                {
                    ...
                    b.Property<float>("WillBeHoldUnit")
                        .HasColumnType("float");

                    b.Property<float>("WillBeReclaimUnit")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.TransactionAggregate.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 13,
                            Name = "Gia hạn hợp đồng",
                            Permission = "RENEW_CONTRACT"
                        });
                });
                    ...
                    b.OwnsOne("ContractManagement.Domain.AggregatesModel.BaseContract.ContractTimeLine", "TimeLine", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("StartBillingDate")
                                .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.InContractAggregate.SharingRevenueLineDetail", b =>
                {
                    b.HasOne("ContractManagement.Domain.AggregatesModel.InContractAggregate.ContractSharingRevenueLine", null)
                        .WithMany()
                        .HasForeignKey("SharingLineId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ContractManagement.Domain.AggregatesModel.OutContractAggregate.ServicePackageSuspensionTime", b =>
                {
                    b.HasOne("ContractManagement.Domain.AggregatesModel.OutContractAggregate.OutContractServicePackage", "Channel")
                        .WithMany()
                        .HasForeignKey("OutContractServicePackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
