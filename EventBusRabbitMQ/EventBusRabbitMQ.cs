...
namespace EventBusRabbitMQ
{
    ...
    {
        public const string BROKER_NAME = "HTC_ITC_BILLING_EVENT_BUS";

        private readonly IRabbitMQPersistentConnection _persistentConnection;
        private readonly ILogger<EventBusRabbitMQ> _logger;
        private readonly IEventBusSubscriptionsManager _subsManager;
        private readonly ILifetimeScope _autoFac;
        private readonly string AUTOFAC_SCOPE_NAME = "HTC_ITC_BILLING_EVENT_BUS";
        ...
        public void Publish(IntegrationEvent @event)
        {
            ...
            using var channel = _persistentConnection.CreateModel();
            _logger.LogTrace("Declaring Rabbit exchange to publish event: {EventId}", @event.Id);
            ...
            policy.Execute(() =>
            {
                ...
                _logger.LogTrace("Publish event to RabbitMQ: {EventId}", @event.Id);
